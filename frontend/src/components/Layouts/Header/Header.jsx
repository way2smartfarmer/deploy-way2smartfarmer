...
const Header = () => {
  ...
  return (
    <header className="bg-primary-blue fixed top-0 py-2.5 w-full z-10 nav_hedder">
      {/* <!-- navbar container --> */}
      <div className="w-full sm:w-9/12 px-1 sm:px-4 m-auto flex justify-between items-center relative">
        ...
        <div className="flex items-center flex-1">
          <Link className="h-7 mr-1 sm:mr-4" to="/">
            <img
              draggable="false"
              className="h-full w-full object-contain main-logo"
              src={logo}
        ...
        <div className="flex items-center justify-between ml-1 sm:ml-0 gap-0.5 sm:gap-7 relative">
          {isAuthenticated === false ? (
            ...
            <span
              className="userDropDown flex items-center text-white font-medium gap-1 cursor-pointer login"
